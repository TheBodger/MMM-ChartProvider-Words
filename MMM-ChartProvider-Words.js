...
Module.register("MMM-ChartProvider-JSON", {
	...
	defaults: {
		...
		input: null,							// "feedprovider" or https// url or local file name

		//word feed:							//one definition of how the data in input will be processed
	...
	notificationReceived: function (notification, payload, sender) {
		...
		if ((notification == 'MMM-ChartDisplay_READY_FOR_ACTION' || notification == 'MMM-ChartDisplay_SEND_MORE_DATA') && this.myconsumer(payload.consumerid)) {
			...
			//if we are going to receive output from a feed provider, then we need to let the world know and wait for input from them
			//
			// otherwise
			// we need to use our nice little nodehelper to get us the stuff 
